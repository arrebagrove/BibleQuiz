...
namespace Bible_Quiz
{
    ...
    /// </summary>
    public sealed partial class NewTestament : Page
    {
        ...
        private void initialize_Questions()
        {
            ...
            question.text = "Name two people who oppossed Moses and Aaron as recorded in the New Testament";
            question.a = "Jannes and Jambres";
            question.b = "Joshua and Caleb";
            question.c = "Aaron and Joshua";
            question.d = "Gaddiel and Shaphat";
            question.answer = "Jannes and Jambres";
            question.timer = 10;
